...
export default function CreateQuiz({ navigation }) {
    ...
    async function handlePickImgBtnClick() {
        let result = ____ // add here the code for image picker feature (recall from quizmania app!)
        if (!result.cancelled) {
    ...
    async function hanldeCreateBtnClick() {
        ...
        if (createdByUserId) {
            ...
            if (quizImgUri) {
                ...
                insertQuizInFirebase(_____, ____); // add here: createdByUserId and the quizImgUri to this function
            }
    ...
    function insertQuizInFirebase(createdByUserId, imgUri) {
        ...
        const quizesDbRef = firebase.app().database().ref(''); // add your db name
        quizesDbRef
            .child(____) // add here: pass in the insertKey here
            .set({
                createdByUserId,
                quizImgUri: imgUri,
                quizName,
