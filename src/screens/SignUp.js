...
export default class SignUp extends ValidationComponent {
            ...
            firebase.auth().createUserWithEmailAndPassword(this.state.email, this.state.password)
                .then((user) => {
                    try {
                        ...
                        const usersDbRef = firebase.app().database().ref(''); // create and add your database in your firebase
                        usersDbRef
                            .child(userId)
                            .set({
                                userId,
                            ...
                            // add a keyword which can be used to facilitate asynchronous calls
                                _____ (error) => {
                                    if (error) {
                                        this.hideLoader();
    ...
    handleSignInBtnClick = () => {
        ...
        this.props.navigation.navigate(''); // add here
    }
                ...
                <ScrollView style={styles.container}>
                    ...
                    <View style={styles.form}>
                        ...
                        <TextInput
                            ...
                            // onChangeText must call setState function and set the name
                            ______ // add here
                        />
